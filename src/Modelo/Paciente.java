...
public class Paciente extends Persona {
    ...
    public Paciente(int idPaciente, int idPersona, String identificacion, String primNombre, String segNombre, String primApellido, String segApellido, String email, String direccion, String barrio, String canton, String provincia, String telefono, Date fechaNacimiento, String lugar, String pais, String genero, String estadoCivil, String sexo, byte[] foto, String etnia, Date fechaRegistro, String contactoEmergencia, boolean estadoActivo, String tipoSangre) {
    super(idPersona, identificacion, primNombre, segNombre, primApellido, segApellido, email, direccion, barrio, canton, provincia, telefono, fechaNacimiento, lugar, pais, genero, estadoCivil, sexo, foto, etnia, fechaRegistro,  contactoEmergencia, estadoActivo, tipoSangre);
    this.idPaciente = idPaciente;
